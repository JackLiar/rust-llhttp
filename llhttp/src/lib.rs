...
#[repr(C)]
pub enum Error {
    HPE_OK = llhttp::llhttp_errno_HPE_OK as isize,
    HPE_INTERNAL = llhttp::llhttp_errno_HPE_INTERNAL as isize,
    HPE_STRICT = llhttp::llhttp_errno_HPE_STRICT as isize,
    HPE_LF_EXPECTED = llhttp::llhttp_errno_HPE_LF_EXPECTED as isize,
    HPE_UNEXPECTED_CONTENT_LENGTH = llhttp::llhttp_errno_HPE_UNEXPECTED_CONTENT_LENGTH as isize,
    HPE_CLOSED_CONNECTION = llhttp::llhttp_errno_HPE_CLOSED_CONNECTION as isize,
    HPE_INVALID_METHOD = llhttp::llhttp_errno_HPE_INVALID_METHOD as isize,
    HPE_INVALID_URL = llhttp::llhttp_errno_HPE_INVALID_URL as isize,
    HPE_INVALID_CONSTANT = llhttp::llhttp_errno_HPE_INVALID_CONSTANT as isize,
    HPE_INVALID_VERSION = llhttp::llhttp_errno_HPE_INVALID_VERSION as isize,
    HPE_INVALID_HEADER_TOKEN = llhttp::llhttp_errno_HPE_INVALID_HEADER_TOKEN as isize,
    HPE_INVALID_CONTENT_LENGTH = llhttp::llhttp_errno_HPE_INVALID_CONTENT_LENGTH as isize,
    HPE_INVALID_CHUNK_SIZE = llhttp::llhttp_errno_HPE_INVALID_CHUNK_SIZE as isize,
    HPE_INVALID_STATUS = llhttp::llhttp_errno_HPE_INVALID_STATUS as isize,
    HPE_INVALID_EOF_STATE = llhttp::llhttp_errno_HPE_INVALID_EOF_STATE as isize,
    HPE_INVALID_TRANSFER_ENCODING = llhttp::llhttp_errno_HPE_INVALID_TRANSFER_ENCODING as isize,
    HPE_CB_MESSAGE_BEGIN = llhttp::llhttp_errno_HPE_CB_MESSAGE_BEGIN as isize,
    HPE_CB_HEADERS_COMPLETE = llhttp::llhttp_errno_HPE_CB_HEADERS_COMPLETE as isize,
    HPE_CB_MESSAGE_COMPLETE = llhttp::llhttp_errno_HPE_CB_MESSAGE_COMPLETE as isize,
    HPE_CB_CHUNK_HEADER = llhttp::llhttp_errno_HPE_CB_CHUNK_HEADER as isize,
    HPE_CB_CHUNK_COMPLETE = llhttp::llhttp_errno_HPE_CB_CHUNK_COMPLETE as isize,
    HPE_PAUSED = llhttp::llhttp_errno_HPE_PAUSED as isize,
    HPE_PAUSED_UPGRADE = llhttp::llhttp_errno_HPE_PAUSED_UPGRADE as isize,
    HPE_USER = llhttp::llhttp_errno_HPE_USER as isize,
}
